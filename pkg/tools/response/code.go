...
var (
	...
	RoleBindApiError       = Response{Code: 40047, Message: "角色绑定接口权限失败"}
	RoleUnBindApiError     = Response{Code: 40048, Message: "角色解除接口权限失败"}
	RoleBindMenuError      = Response{Code: 40022, Message: "角色存在与菜单的绑定关联，无法删除"}
)
